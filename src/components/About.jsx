  ...
  return (
    <section id="about" className="about section-shell">
      ...
      <div className="about-copy">
        ...
        <p className="section-lead">
          My primary stack centers on React Native &amp; Expo for mobile and Next.js/React for the web. Beyond crafting clean, responsive interfaces, I integrate frontend systems with robust backend APIs to deliver seamless, end-to-end user experiences.
        </p>
        <p className="section-lead">
